  ...
  ScrollTrigger.enable = function enable() {
    ...
    if (ScrollTrigger_gsap) {
      ...
      if (ScrollTrigger_body) {
        ...
        ScrollTrigger_addListener(ScrollTrigger_body, "touchstart", _passThrough); //works around Safari bug: https://greensock.com/forums/topic/21450-draggable-in-iframe-on-mobile-is-buggy/
