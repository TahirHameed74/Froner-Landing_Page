	...
	return (
		<div className="bg-[#D0E5E4]   h-full">
			...
			<div
				...
				<div className="flex md:mt-10 lg:text-[41.6px] text-[#4a4036] md:text-[40px] text-lg gap-5 items-center">
			...
			<div id="how-it-works  " className="mt-2 w-4/5 justify-center mx-auto ">
				<h1 className=" forner-heading-2  font-[clashDisplay] md:text-[30px] text-center opacity-0 text-[#4a4036]  lg:text-5xl uppercase text-xl">
					HOW KRISS.AI WORKS
				</h1>
				<video
				...
				<div className="w-1/2 h-4/5  items-center border-2 border-[#4a4036] p-2 rounded-xl">
					<div className="flex flex-col">
						...
						<p className="p-2 text-start text-[#4a4036] font-[clashDisplay]">
							...
							time-consuming. With the help of the AI chatbot, we've streamlined
							appointment scheduling, dental inquiries, and follow-up care. This
							technology has incredibly reduced our administrative workload,
							allowing us to focus more on providing top-notch oral care to our
							patients. It's like having an extra pair of hands that works
							24/7!"
						</p>
						<div className="border-[1px] w-full border-[#4a4036]" />
					</div>
					<button className="flex border-[1px] border-[#4a4036] items-center text-[#4a4036] p-2 mt-2">
						<img src="/right-arrow.png" className="w-5" alt="Right Arrow" />
						<p className="ml-2">visit now</p>
					</button>
				</div>
				<div className="w-1/2 h-4/5  ml-4  items-center  border-2 border-[#4a4036] p-2 rounded-xl">
					<div className="flex flex-col">
						...
						<p className=" p-2   text-start  text-[#4a4036] font-[clashDisplay]">
							...
							dramatically enhanced our patient service. It instantly addresses
							patient questions, offering them convenient and comprehensive
							responses. Our patients are happier with the quick,
							round-the-clock assistance, and our staff is relieved from the
							constant ringing of phones. It's a win-win solution for us!"
						</p>
						<div className="border-[1px] w-full  border-[#4a4036]" />
					</div>
					<button className="flex border-[1px] border-[#4a4036] items-center text-[#4a4036] p-2 mt-2">
						<img src="/right-arrow.png" className="w-5"></img>
						<p className="ml-2">visit now</p>
					</button>
				</div>
			</div>
